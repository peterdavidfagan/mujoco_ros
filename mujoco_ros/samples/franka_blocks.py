...
import mujoco_ros
from mujoco_ros.franka_env import FrankaBlocks

model_filepath = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'models', 'blocks.mjb')
